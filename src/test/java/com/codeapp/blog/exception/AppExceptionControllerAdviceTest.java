...
public class AppExceptionControllerAdviceTest {
	...
	@InjectMocks
	AppExceptionControllerAdvice expController;
	...
	public void testHandleExceptionInternal() throws Exception {
		...
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/blog/admin/users/test"))
